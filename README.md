...
| Camada | Tecnologia |
| --- | --- |
| Interface | HTML5, CSS3, JavaScript e Bootstrap 5.3.3 |
| Gráficos | Chart.js e `chartjs-plugin-datalabels` |
| Dados | Arquivos CSV carregados com `fetch` |
| Hospedagem | Servidor HTTP estático, incluindo GitHub Pages |
...
1. Coloque as páginas HTML, os scripts JavaScript, `estilo.css`, os CSVs anuais e o logotipo na **mesma pasta**, preservando exatamente os nomes referenciados nos arquivos HTML e JavaScript.
2. Na pasta do projeto, inicie um servidor local:
...
1. Envie os arquivos para a raiz do repositório, preservando seus nomes e letras maiúsculas/minúsculas.
2. Em **Settings → Pages**, selecione **Deploy from a branch**, a branch desejada e a pasta **`/ (root)`**.
3. Ao publicar, confira o carregamento de `index.html`, dos dois CSVs anuais e dos recursos visuais.
